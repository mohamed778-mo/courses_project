...
const { upload_pdf,get_pdf,delete_pdf,get_pdfs, get_imgs, get_img, upload_images,delete_image} = require('../controllers/uploads_control');
...
router.delete('/teacher/delete_img/:img_id', delete_image);
